...
import com.example.ecommerce_application.viewmodel.factory.BaseCategoryViewModelFactory
...
@AndroidEntryPoint
class PrintedshirtsFragment : BaseCategoryFragment() {

    @Inject
    lateinit var firestore: FirebaseFirestore

    val viewModel by viewModels<CategoryViewModel> {
        BaseCategoryViewModelFactory(firestore, Category.Printedshirts)
    }
