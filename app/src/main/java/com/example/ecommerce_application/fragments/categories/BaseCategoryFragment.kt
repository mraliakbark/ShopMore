...
import com.example.ecommerce_application.databinding.FragmentBaseCategoryBinding
...
open class BaseCategoryFragment:Fragment(R.layout.fragment_base_category) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.nestedScrolledBaseCategory.setOnScrollChangeListener(NestedScrollView.OnScrollChangeListener{ v, _, scrollY, _, _ ->
